...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<c:url value='/resources/assets/ico/chat-rooms.jpg'/>" />
...
<br>
			...
			<div class="row">
			<div class="col-lg-4">
						<img class="img-responsive" src="<c:url value='/resources/assets/img/chat-rooms.jpg'/> " align="">
					</div>
		...
		<!--<div id="greywrap">-->
			<div class="container">
				<div class="row white centered">
					<div class="col-lg-6">
						<img class="img-responsive" src="<c:url value='/resources/assets/img/mac.png'/> " align="left">
					</div>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="<c:url value='/resources/assets/img/team/team05.jpg'/> " height="120px" width="120px" alt="">
					<br>
					<h4><b>Jaye Smith</b></h4>
					<a href="#" class="icon icon-twitter"></a>
					<a href="#" class="icon icon-facebook"></a>
					<a href="#" class="icon icon-flickr"></a>
					<p>The first time I heard Mike speak, I was blown away and it really impacted my own life. He really makes you think about what is truly important.</p>
				</div>
				//
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="<c:url value='/resources/assets/img/team/team06.jpg'/> " height="120px" width="120px" alt="">
					<br>
					<h4><b>Jaye Smith</b></h4>
					<a href="#" class="icon icon-twitter"></a>
					<a href="#" class="icon icon-facebook"></a>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="<c:url value='/resources/assets/img/team/team07.jpg'/> " height="120px" width="120px" alt="">
					<br>
					<h4><b>De Collin</b></h4>
					<a href="#" class="icon icon-twitter"></a>
					<a href="#" class="icon icon-facebook"></a>
					<a href="#" class="icon icon-flickr"></a>
					<p>Let us change our traditional attitude to the construction of programs. Instead of imagining that our main task is to instruct a computer what to to, let us concentrate rather on explaining to human beings what we want a computer to do</p>
				</div>
				
				
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="<c:url value='/resources/assets/img/team/team08.jpg'/> " height="120px" width="120px" alt="">
					<br>
					<h4><b>Richa</b></h4>
					<a href="#" class="icon icon-twitter"></a>
					<a href="#" class="icon icon-facebook"></a>
